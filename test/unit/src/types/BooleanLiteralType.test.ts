import {BooleanLiteralType, booleanType} from "../../../../src"
...
const GENERATED_TRANSLATE_NAME_REGEXP = new RegExp('^__TTG_Anonymous_translate_booleanLiteral_[0-9]+$')
const VALUE = false
    ...
    describe('with name', () => {
        ...
        it('should generate the correct translate code', () => {
            instance.getTranslateCode().should.equal(Mustache.render(TRANSLATE_CODE, {
                ...
                valueTranslateName: '__TTG_translate_boolean',
            }))
        })
